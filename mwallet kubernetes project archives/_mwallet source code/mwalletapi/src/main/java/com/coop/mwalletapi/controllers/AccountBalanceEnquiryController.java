...
public class AccountBalanceEnquiryController {
    
    private static final Logger logger = LogManager.getLogger(AccountBalanceEnquiryController.class.getName());
    ...
    @RequestMapping(value = "/GetBalance/v1.0", method = {RequestMethod.GET, RequestMethod.POST}, produces = MediaType.APPLICATION_JSON_VALUE)
    public Object GetCustomerDetails(HttpServletRequest request) throws IOException{
        ...
        try
        {
            ...
            Class cls = Class.forName("com.coop.mwalletapi.accountbalancelibrary.services.AccountBalanceEnquiryService");
            Class[] argTypes = new Class[] { MwalletCommonDataReq.class };

            Method meth = cls.getMethod("getAccountBalanceByAccountAlias", argTypes);
            ...
            logger.error(AccountBalanceEnquiryController.class.getName() + " MethodName: " + Thread.currentThread().getStackTrace()[1].getMethodName() + " " + ex, ex);
        }
