...
public class DbV3 {
    ...
    private static final Logger logger = LogManager.getLogger(DbV3.class.getName());
    ...
    @Autowired
    public DbV3(DataSource dsPassed) {
        this.jdbcTemplate = new JdbcTemplate(dsPassed);
        this.ds = dsPassed;
    }

    public AccountStatementDataDbResponse getAccountStatment(String accountAlias, int entityId, String transactionId, int maxRows, int pageNumber, String startDate, String endDate, ResponseHeader header) {
        ...
        try {
            ...
            .withProcedureName("GET_ACCOUNT_STATEMENT_V3")
            ...
            .withoutProcedureColumnMetaDataAccess()
                    .declareParameters(
                            ...
                            new SqlParameter("PAGENUMBER", Types.VARCHAR),
                            new SqlParameter("START_DATE", Types.VARCHAR),
                            new SqlParameter("END_DATE", Types.VARCHAR),
            ...
            inParamMap.put("PAGENUMBER", pageNumber);
            ...
            logger.error(DbV3.class.getName() + " MethodName: " + Thread.currentThread().getStackTrace()[1].getMethodName() + " " + ex, ex);
        }
